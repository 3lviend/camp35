class WorkEntry < ActiveRecord::Base
  ...
  attr_accessible :work_chart_id, :date_performed, :work_entry_fees_attributes, :description, :work_entry_durations_attributes, :created_by, :modified_by, :work_entry_fees_attributes
